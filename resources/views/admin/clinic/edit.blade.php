    ...
    <div class="tabs">
                     ...
                     <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-7 {{ $errors->first('clinic_name', 'has-error') }}">
                            <input type="text" name="clinic_name" id="clinic_name" value="{{ old('clinic_name',$clinic->clinic_name) }}" class="form-control unicode" placeholder="အထွေထွေရောဂါကုဆေးခန်း">
                            ...
                            <select class="form-control" name="tsh_id" id="tsh_id">
                                  ...
                                  @foreach($townships as $township)
                                    <option value="{{ $township->id }}"
                                        {{ old('tsh_id', $clinic_history->tsh_id) == $township->id ? 'selected' : '' }}>
                                        {{ $township->tsh_name_mm }}
                                    </option>
                                  @endforeach
                            </select>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <div class="col-md-7 {{ $errors->first('clinic_address', 'has-error') }}">
                             <textarea name="clinic_address" class="form-control" placeholder="ပျဉ်းမနား" id="clinic_address">{{$clinic->clinic_address}}</textarea>
                   ...
                   <div class="col-md-6">
                        ...
                        <div class="col-md-7 {{ $errors->first('licence_id', 'has-error') }}">
                            <select class="form-control" name="licence_id" id="licence_id">
                                  ...
                                  @foreach($licence_types as $licence_type)
                                    <option value="{{ $licence_type->id }}"
                                        {{ old('licence_id', $clinic_history->lic_id) == $licence_type->id ? 'selected' : '' }}>
                                        {{ $licence_type->lic_name}}
                                    </option>
                                  @endforeach
                            </select>
                          </div>
                        ...
                        <div class="col-md-7 {{ $errors->first('sub_licences_id', 'has-error') }}">
                            <select class="form-control" name="sub_licences_id" id="sub_licences_id">
                                  ...
                                  @foreach($sub_licences as $sub_licence)
                                    <option value="{{ $sub_licence->id }}"
                                        {{ old('sub_licences_id', $clinic_history->sub_lic_id) == $sub_licence->id ? 'selected' : '' }}>
                                        {{ $sub_licence->sub_lic_name }}
                                    </option>
                                  @endforeach
                            </select>
                          </div>
                    ...
                    <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-7 {{ $errors->first('licence_no', 'has-error') }}">
                            <input type="text" name="licence_no" id="licence_no" value="{{ old('licence_no',$clinic_history->lic_no) }}" class="form-control unicode" placeholder="၁၈">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7 {{ $errors->first('issue_date', 'has-error') }}">
                        ...
                        value="{{ old('issue_date',$clinic_history->issue_date) }}">
                      </div>
                    </div><br>
                    <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-7 {{ $errors->first('duration', 'has-error') }}">
                            <input type="number" name="duration" id="duration" value="{{ old('duration',$clinic_history->duration) }}" class="form-control unicode" placeholder="၂နှစ်">
                    ...
                    <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-7 {{ $errors->first('expire_date', 'has-error') }}">
                            <input type="text" name="expire_date" id="expire_date" class="form-control unicode" placeholder="01-08-2022" value="{{ old('expire_date',$clinic_history->expire_date) }}">
        ...
        <div class="tabby-tab" style="margin-right: 5px;">
            ...
            <div class="tabby-content">
                 ...
                 <div class="col-md-10">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-7 {{ $errors->first('ph_no', 'has-error') }}">
                            ...
                            <input type="number" name="ph_no" id="ph_no" value="{{ old('ph_no',$clinic->phone) }}" class="form-control unicode" placeholder="09987656787">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 {{ $errors->first('owner_address', 'has-error') }}">
                            ...
                            <textarea name="owner_address" class="form-control" placeholder="ပျဉ်းမနား" id="owner_address">{{$clinic->address}}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 {{ $errors->first('owner_photo', 'has-error') }}">
                            ...
                            <input type="file" name="owner_photo" id="owner_photo" value="{{ old('owner_photo') }}" class="form-control unicode"><br>
               ...
               <div style="width: 100%">
                   <a class="btn btn-primary unicode" id="owner_back" style="float: left;">Back</a>
                   <a class="btn btn-success unicode" id="owner_next" style="float: right;">Next</a>
                <!-- <button type="submit" class="btn btn-success unicode" id="save" style="float: right;">Next</button> -->
               </div>
            ...
            <div class="tabby-content">
                 <div class="row">
                      <div class="col-md-2">
                        ...
                        <div class="col-md-5 {{ $errors->first('tsh_id', 'has-error') }}">
...
@section('js')
    ...
    <script>
        ...
        $("#clinic_next").click(function(){
                    ...
                    if (name && clinic_address &&  township != "မြို့နယ်" && licence_id != "လိုင်စင်အမျိုးအစား" && sub_licences_id != "လိုင်စင်ခွဲ" && licence_no && issue_date && duration && expire_date) {
                        // alert("HI");
                        $("#tab-2").prop("checked", true);
                        
                    }
                    
                    $("#owner_next").click(function(){
                        ...
                        if (owner_name && ph_no && nrc && owner_address) {
