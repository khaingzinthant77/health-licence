                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-7 {{ $errors->first('clinic_address', 'has-error') }}">
                            ...
                            <textarea name="clinic_address" class="form-control" placeholder="ပျဉ်းမနား">{{$clinic->clinic_address}}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 {{ $errors->first('owner_address', 'has-error') }}">
                            ...
                            <textarea name="owner_address" class="form-control" placeholder="ပျဉ်းမနား">{{$clinic->address}}</textarea>
