            ...
            <div class="row">
               <div class="col-md-6">
                  <!--  <div class="row">
                   ...
                   <div class="row">
                       <label class="col-md-4 unicode">လိုင်စင်*</label>
                   ...
                   <div class="row">
                       <label class="col-md-4 unicode">လိုင်စင်ခွဲ*</label>
                   ...
                   <div class="row">
                       <label class="col-md-4 unicode">လိုင်စင်နံပါတ်*</label>
                        <div class="col-md-7 {{ $errors->first('doc_phone', 'has-error') }}">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <label class="col-md-4 unicode">စတင်ခွင့်ပြုသည့်ရက်စွဲ*</label>
                        <div class="col-md-7 {{ $errors->first('doc_address', 'has-error') }}">
