...
@section('content')
  ...
  <form action="{{route('sublicence.update',$sublicences->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                       ...
                                       <input type="text" name="sub_lic_name" class="form-control unicode" id="sub_lic_name" value="{{$sublicences->sub_lic_name}}" > 
            ...
            <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                       ...
                                       <input type="text" name="sub_lic_short" class="form-control unicode" id="sub_lic_short" value="{{$sublicences->sub_lic_short}}" > 
